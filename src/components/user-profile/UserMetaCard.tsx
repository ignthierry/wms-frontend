...
export default function UserMetaCard() {
  ...
  const [user, setUser] = React.useState<any>({ name: "Loading...", email: "", phone: "", role: "User" });
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 dark:border-gray-800">
              <span className="text-gray-500 w-8 h-8 flex items-center justify-center text-xl font-bold">
